/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface BaseEnv --env stage` (hash: b4adab19c8af1da70ff071b0f1d49393)
...
declare namespace Cloudflare {
    ...
    interface Env {
        ...
        HALO_RESEARCH_WORKFLOW_V2: Workflow<Parameters<import("./src/index").HaloResearchWorkflowV2['run']>[0]['payload']>;
        GOLDEN_PHEASANT_WORKFLOW: Workflow<Parameters<import("./src/index").GoldenPheasantWorkflow['run']>[0]['payload']>;
        GODFATHER_OFFER_WORKFLOW: Workflow<Parameters<import("./src/index").GodfatherOfferWorkflow['run']>[0]['payload']>;
    }
}
