...
--> statement-breakpoint
DROP TABLE IF EXISTS `brand_pillars`;--> statement-breakpoint
DROP TABLE IF EXISTS `content_ideas`;--> statement-breakpoint
DROP TABLE IF EXISTS `market_research`;--> statement-breakpoint
DROP TABLE IF EXISTS `offers`;--> statement-breakpoint
DROP TABLE IF EXISTS `posts`;--> statement-breakpoint
DROP TABLE IF EXISTS `campaigns`;--> statement-breakpoint
DROP TABLE IF EXISTS `generations`;--> statement-breakpoint
DROP TABLE IF EXISTS `user_credits`;--> statement-breakpoint
