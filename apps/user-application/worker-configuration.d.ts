/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env --env stage` (hash: b513fdbdd108ceb8fc520ad6abad73a2)
// Runtime types generated with workerd@1.20251202.0 2025-07-11 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
	}
	interface Env {
		BETTER_AUTH_URL: "https://hero.williamjshaw.ca";
		...
		ASSETS: Fetcher;
		HALO_RESEARCH_WORKFLOW: Workflow /* HaloResearchWorkflow from data-service-stage */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "VITE_BASE_HOST" | "CLOUDFLARE_ENV" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "STRIPE_KEY" | "STRIPE_PRODUCT_BASIC" | "STRIPE_PRODUCT_PREMIUM" | "STRIPE_WEBHOOK_KEY" | "APP_SECRET">> {}
}
